...
def parse_args(argv):
    ...
    parser.add_argument(
        "--hopfield", type=bool, default=False, help="Hopfield layer instead of transformer  (default: %(default)s)"
    )
...
def main(argv):
    ...
    net = TCM(config=[2,2,2,2,2,2], head_dim=[8, 16, 32, 32, 16, 8], drop_path_rate=0.0, N=args.N, M=320,hopfield=args.hopfield)
    net = net.to(device)
